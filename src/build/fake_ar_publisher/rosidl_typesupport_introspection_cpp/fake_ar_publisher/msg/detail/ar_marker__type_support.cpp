...
{
  new (message_memory) fake_ar_publisher::msg::ARMarker(_init);
}

void ARMarker_fini_function(void * message_memory)
{
  auto typed_message = static_cast<fake_ar_publisher::msg::ARMarker *>(message_memory);
  typed_message->~ARMarker();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember ARMarker_message_member_array[4] = {
  {
    "header",  // name
    ...
    offsetof(fake_ar_publisher::msg::ARMarker, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fake_ar_publisher::msg::ARMarker, id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fake_ar_publisher::msg::ARMarker, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fake_ar_publisher::msg::ARMarker, confidence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ARMarker_message_members = {
  "fake_ar_publisher::msg",  // message namespace
  "ARMarker",  // message name
  4,  // number of fields
  sizeof(fake_ar_publisher::msg::ARMarker),
...
{
  return &::fake_ar_publisher::msg::rosidl_typesupport_introspection_cpp::ARMarker_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fake_ar_publisher, msg, ARMarker)() {
  return &::fake_ar_publisher::msg::rosidl_typesupport_introspection_cpp::ARMarker_message_type_support_handle;
}
