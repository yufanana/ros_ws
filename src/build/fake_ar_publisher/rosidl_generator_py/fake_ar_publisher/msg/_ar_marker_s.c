...
bool fake_ar_publisher__msg__ar_marker__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fake_ar_publisher.msg._ar_marker.ARMarker", full_classname_dest, 41) == 0);
  }
  fake_ar_publisher__msg__ARMarker * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of ARMarker */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fake_ar_publisher.msg._ar_marker");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ARMarker");
