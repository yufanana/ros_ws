...
class Metaclass_ARMarker(type):
    """Metaclass of message 'ARMarker'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('fake_ar_publisher')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'fake_ar_publisher.msg.ARMarker')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__ar_marker
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__ar_marker
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__ar_marker
            cls._TYPE_SUPPORT = module.type_support_msg__msg__ar_marker
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__ar_marker
...
class ARMarker(metaclass=Metaclass_ARMarker):
    """Message class 'ARMarker'."""
